...
\section{EXPERIENCE}
  ...
  \begin{itemize}  \itemsep -2pt % reduce space between items
    ...
    \item Managed a sophisticated job queuing using Resque/Redis, which directed tremendous amounts of API traffic across nearly 200 different APIs.
    ...
    \item Responded to, diagnosed, and fixed countless "fires."
