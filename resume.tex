...
\section{EXPERIENCE}
  ...
  San Francisco, CA
  \begin{itemize}  \itemsep -2pt % reduce space between items
    \item Built out a Vagrant developer environment that utilizes the same Chef infrastructure code as the production enviornment.
    ...
    \item Movied a manually-maintained Nagios alerting system to one fully managed as Chef configuration code.
